...
class LivePlayerViewController: DailymotionBaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = NSLocalizedString("Live Player", comment: "")
        initPlayer()
    ...
    func initPlayer() {
        ...
        Dailymotion.createPlayer(playerId: "xix5x", videoId: "xqjkfz",playerParameters: playerParams , playerDelegate: self, logLevels: [.all]) { [weak self]  playerView, error in
