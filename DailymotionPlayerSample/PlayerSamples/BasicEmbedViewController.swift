//
//  BasicEmbedViewController.swift
...
class BasicEmbedViewController: DailymotionBaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = NSLocalizedString("Basic Embed", comment: "")
        initPlayer()
    ...
    func initPlayer() {
        ...
        let playerParams = DMPlayerParameters(mute: true)
        ...
        Dailymotion.createPlayer(playerId: "xix5x", videoId: "x84sh87",playerParameters: playerParams , playerDelegate: self, logLevels: [.all]) { [weak self]  playerView, error in
